...
import { upload_home_Ad, upload_land_Ad } from "../../../rtk/slices/adSlice";
...
const PostLand = () => {
  ...
  const handleSubmit = (values) => {
    ...
    dispatch(upload_land_Ad(formData));
          ...
          <div className="flex items-center gap-12 py-4">
            ...
            <div className="mb-4 flex items-center">
              ...
              <Field
                ...
                name="zoneType"
                id="zoneType"
                className="block w-full rounded-md border border-gray-300 p-2 text-sm focus:ring-blue-500 focus:border-blue-500"
              >
